...
function renderOptions(){
	...
	<div class="input-group mb-3 px-5">
  		...
  		<select class="custom-select mr-5" id="drop-location">
			...
			<option value="27565">Oxford</option>
  	...
  	<div class="d-flex flex-wrap justify-content-around" data-toggle="modal" data-target="#exampleModal">
  	<div>
...
function renderContact(){
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputTitulo" placeholder="Title">
  </div>
 <div class="form-group">
...
function renderModal(infoPet){
	let name = infoPet[0];
	let photo = infoPet[1];
	let description = infoPet[2];
	let breed = infoPet[3];
	let sex = infoPet[4];
	let size = infoPet[5];
	let age = infoPet[6];
	...
	return `	
						<img src="${photo}" class="img-modal img-thumbnail"></img>	
        		<p><span class="text-danger font-weight-bold">Description: </span>${description}</p>
        		<p><span class="text-danger font-weight-bold">Breed: </span>${breed}</p>
        		<p><span class="text-danger font-weight-bold">Sex: </span>${sex}</p>
        		<p><span class="text-danger font-weight-bold">Size: </span>${size}</p>
        		<p><span class="text-danger font-weight-bold">Age: </span>${age}</p>
	`
}
